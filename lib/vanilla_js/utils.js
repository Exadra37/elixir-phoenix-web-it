...
const animatedFadeInById = function(id, duration) {
  removeClassFrom(id, 'animate__fadeOut')
  addClassTo(id, "animate__fadeIn")
  displayElement(id)
}


const animatedFadeOutById = function(id, duration) {
  removeClassFrom(id, 'animate__fadeIn')
  addClassTo(id, "animate__fadeOut")
  setTimeout(function () {
    hideElement(id)
    removeClassFrom(id, 'animate__fadeOut')
  }, duration);
